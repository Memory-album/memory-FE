...
const PhotosInAlbum = ({ params }: PropType) => {
  const albumId = params.id;
  const currentPhotoId = params.photoId;

  const [images, setImages] = useState([
    { id: '0', src: '/images/example.png', isLiked: false, name: '사진1' },
    { id: '1', src: '/images/example2.png', isLiked: true, name: '사진2' },
    { id: '2', src: '/images/1.png', isLiked: false, name: '사진3' },
    { id: '3', src: '/images/2.png', isLiked: true, name: '사진4' },
    { id: '4', src: '/images/3.png', isLiked: false, name: '사진5' },
    { id: '5', src: '/images/4.png', isLiked: false, name: '사진6' },
    { id: '6', src: '/images/5.png', isLiked: true, name: '사진7' },
    { id: '7', src: '/images/6.png', isLiked: false, name: '사진8' },
  ]);
