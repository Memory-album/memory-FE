...
const PhotosInAlbum = () => {
  ...
  const [images, setImages] = useState([
    { id: '0', src: '/images/example.png', isLiked: false },
    { id: '1', src: '/images/example2.png', isLiked: true },
    { id: '2', src: '/images/1.png', isLiked: false },
    { id: '3', src: '/images/2.png', isLiked: true },
    { id: '4', src: '/images/3.png', isLiked: false },
    { id: '5', src: '/images/4.png', isLiked: false },
    { id: '6', src: '/images/5.png', isLiked: true },
    { id: '7', src: '/images/6.png', isLiked: false },
  ]);
  ...
  return (
    <div className="ForFnbmarginBottom mx-4">
      <ResponsiveMasonry
        ...
        <Masonry columnsCount={3} gutter="15px">
          {images.map((image, i) => (
            <div className="relative" key={i}>
              <Link href={`albums/photo/${image.id}`} key={image.id}>
                <img
                  src={image.src}
